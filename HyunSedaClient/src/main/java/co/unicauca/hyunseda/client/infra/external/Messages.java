package co.unicauca.hyunseda.client.infra.external;
    ...
    public static void sendPaymentConfirmationMessage() {
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .POST(HttpRequest.BodyPublishers.ofString("{\"messaging_product\": \"whatsapp\", \"to\": \"573136463350\", \"type\": \"template\", \"template\": { \"name\": \"hello_world\", \"language\": { \"code\": \"en_US\" } } }"))
                    .build();
